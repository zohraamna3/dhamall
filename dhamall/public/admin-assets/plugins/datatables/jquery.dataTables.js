...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 * previous, first or last partials.
	 ...
	 *  * `partials` - Total number of partials
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of partials of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} partials` The number of partials in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, partials ) {
