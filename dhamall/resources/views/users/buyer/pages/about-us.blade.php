...
@section('content')
    <div class="card shadow-lg border-0 rounded-lg mb-3"
        ...
        <p class="text-center">{{ $aboutUs->Description ?? 'Welcome to Dhamall, your one-stop destination for all your shopping needs.' }}</p>
        <div class="row mt-5">
            <div class="col-md-6">
                <h3 class="text-warning">Our Mission</h3>
                <p>{{ $aboutUs->Mission ?? 'To deliver exceptional value and an unparalleled shopping experience to our customers.' }}</p>
            </div>
            <div class="col-md-6">
                <h3 class="text-warning">Our Vision</h3>
                <p>{{ $aboutUs->Vision ?? 'To become the most trusted and innovative e-commerce platform globally.' }}</p>
            </div>
        </div>
    </div>
@endsection
