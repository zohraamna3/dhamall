...
<div class="position-relative text-white text-center py-5 w-100" style="background: linear-gradient(135deg, #0d0d1a, #1a1a2e); overflow: hidden;">
    ...
    <div class="position-relative z-index-2 p-5 mx-auto rounded-lg" style="max-width: 700px; background: rgba(26, 26, 46, 0.75); backdrop-filter: blur(8px); border-radius: 15px; padding: 30px;">
        ...
        <a href="#shop" class="btn text-dark px-4 py-2 mt-4 fw-bold animate__animated animate__fadeIn animate__delay-2s shop-btn">
    ...
    <div class="position-absolute floating" style="top: 50%; right: 5%; transform: translateY(-50%); z-index: 3;">
        <img src="https://res.cloudinary.com/ddoeppfx0/image/upload/e_background_removal,f_png/cld-sample-5" alt="Earbuds" class="img-fluid" style="max-width: 280px; width: 100%;">
    </div>
</div>
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card shadow-lg border-0 rounded-lg overflow-hidden transition-transform transform hover:scale-105">
                            ...
                            <div class="card-body text-center" style="background: #1a1a2e; color: #b3a31c;">
                                ...
                                <a href="{{ route('product.show', $earbud->id) }}" class="btn w-100 text-white fw-bold py-2 view-details-btn">
            ...
            <section class="my-5">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-4">
                        <div class="card text-white shadow-lg border-0 rounded-lg overflow-hidden transition-transform transform hover:scale-105" style="background: linear-gradient(135deg, #1a1a2e, #24243e);">
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card shadow-lg border-0 position-relative overflow-hidden" style="background: linear-gradient(135deg, #1a1a2e, #0d0d1a); border-radius: 15px;">
                            <div class="card-body p-4">
                                ...
                                <!-- Review Text -->
                                <p class="italic text-light mt-2" style="font-size: 1.1rem; line-height: 1.6; text-shadow: 0 0 8px rgba(255, 255, 255, 0.2);">
                                    "{{ $review->comment }}"
                                </p>
                            ...
                            <!-- Hover Effect -->
                            <div class="position-absolute top-0 start-0 w-100 h-100 bg-gradient opacity-0 transition-opacity" style="background: rgba(255, 255, 255, 0.05);"></div>
                        </div>
                    </div>
