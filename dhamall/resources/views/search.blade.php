                ...
                <div class="accordion" id="filterAccordion">
                        ...
                        <div id="collapsePrice" class="accordion-collapse collapse show" aria-labelledby="headingPrice" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="free">
                                    <label class="form-check-label " for="$0">$0</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="paid">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseRating" class="accordion-collapse collapse show" aria-labelledby="headingRating" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="4.5">
                                    <label class="form-check-label " for="4.5">4.5 & above</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="4.0">
                                    <label class="form-check-label " for="4.0">4.0 & above</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="3.5">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseAvailability" class="accordion-collapse collapse show" aria-labelledby="headingAvailability" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="inStock">
                                    <label class="form-check-label " for="inStock">In Stock</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="outOfStock">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingColor">
                            <button class="accordion-button text-warning bg-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseColor" aria-expanded="true" aria-controls="collapseColor">
                                Color
                            </button>
                        </h2>
                        <div id="collapseColor" class="accordion-collapse collapse show" aria-labelledby="headingColor" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="color-options">
                                    <button class="btn btn-sm btn-outline-light m-1" style="background-color: #ff0000;"></button>
                                    <button class="btn btn-sm btn-outline-light m-1" style="background-color: #00ff00;"></button>
                                    <button class="btn btn-sm btn-outline-light m-1" style="background-color: #0000ff;"></button>
                                    <button class="btn btn-sm btn-outline-light m-1" style="background-color: #ffff00;"></button>
                                    <button class="btn btn-sm btn-outline-light m-1" style="background-color: #000000;"></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSize">
                            <button class="accordion-button text-warning bg-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSize" aria-expanded="true" aria-controls="collapseSize">
                                Size
                            </button>
                        </h2>
                        <div id="collapseSize" class="accordion-collapse collapse show" aria-labelledby="headingSize" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingDiscount">
                            <button class="accordion-button text-warning bg-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDiscount" aria-expanded="true" aria-controls="collapseDiscount">
                                Discount
                            </button>
                        </h2>
                        <div id="collapseDiscount" class="accordion-collapse collapse show" aria-labelledby="headingDiscount" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="10off">
                                    <label class="form-check-label " for="10off">10% off or more</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="20off">
                                    <label class="form-check-label " for="20off">20% off or more</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="30off">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseShipping" class="accordion-collapse collapse show" aria-labelledby="headingShipping" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="freeShipping">
                                    <label class="form-check-label " for="freeShipping">Free Shipping</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="fastShipping">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingCondition">
                            <button class="accordion-button text-warning bg-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCondition" aria-expanded="true" aria-controls="collapseCondition">
                                Condition
                            </button>
                        </h2>
                        <div id="collapseCondition" class="accordion-collapse collapse show" aria-labelledby="headingCondition" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="new">
                                    <label class="form-check-label " for="new">New</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="used">
                                    <label class="form-check-label " for="used">Used</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="refurbished">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSeller" class="accordion-collapse collapse show" aria-labelledby="headingSeller" data-bs-parent="#filterAccordion">
                            <div class="accordion-body">
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="topRatedSeller">
                                    <label class="form-check-label " for="topRatedSeller">Top Rated Seller</label>
                                </div>
                                <div class="form-check">
                                    <input style="border:solid 3px black; margin-left:0px;" type="checkbox" id="verifiedSeller">
                    ...
                    <div class="col-sm-6 col-md-4 mb-4">
                        <div class="card shadow-lg border-0 rounded-lg" style="background: linear-gradient(135deg, #1a1a2e, #0d0d1a); color: white;">
                            @if($product->images->isNotEmpty())
                                <img src="https://res.cloudinary.com/ddoeppfx0/image/upload/e_background_removal,f_png/cld-sample-5" class="card-img-top" alt="{{ $product->name }}">
                            @else
                                <img src="https://res.cloudinary.com/ddoeppfx0/image/upload/e_background_removal,f_png/cld-sample-5" class="card-img-top" alt="{{ $product->name }}">
                            @endif
                            <div class="card-body">
